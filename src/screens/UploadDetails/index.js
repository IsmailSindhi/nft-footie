...
const handleSelectItem = (index) => {
  ...
  const handleUpload = () => {
    ...
    if(selectedfile && itemName && description && royalties && size && propertie && items[selecteditem]) {
      ...
      <div className={cn("section", styles.section)}>
        <div className={cn("container center-1200", styles.container)}>
          <div className={styles.wrapper}>
            ...
            {formError ? <div className="alert alert-primary w-50" role="alert"><p>
              <strong>Fill the form </strong> some fields are missing </p></div>:<div></div>}

            {error ? <div className="alert alert-danger w-50" role="alert"><p>
              <strong>Server error</strong> unable to connect with server  </p></div>:<div></div>}  
            <form className={styles.form} action="">
              <div className={styles.list}>
                <div className={styles.item}>
                  ...
                  <div className={styles.file}>
                    <input className={styles.load} type="file" onChange={(e) => handleFile(e)} />
                  ...
                  {loaded!=0  ? <ProgressBar now={Math.round(loaded)} label={`${Math.round(loaded)}%`}
                  data-toggle="tooltip" data-placement="top" title="File is uploading"
                  /> : ""}
                </div>
                <div className={styles.item}>
              ...
              <div className={styles.options}>
                ...
                <Cards className={styles.cards} items={items} handleSelectItem={handleSelectItem}/>
              </div>
