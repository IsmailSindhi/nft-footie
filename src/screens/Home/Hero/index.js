...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className={cn("section jsb-bg-img", styles.section)} style={{backgroundImage:"url(./bg.png)"}}>
        <div className={cn("container center-1200", styles.container)}>
          <div className={styles.wrapper}>
            <Slider className="creative-slider js-slider-popular slick-initialized slick-slider" {...settings}>
              {items.map((x, index) => (
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.details}>
                      <div className="jsb-wrapper">
                        <button className="jsb-btn" tabindex="0">BEGIN YOUR JOURNEY HERE</button>
                      </div>
                      <div className="main__subtitle h1">Experience Exclusive Euro2020 In Digital Art</div>
                      <div className="main__subtitle h3">CREATE, EXPLORE, &amp; COLLECT EURO2020  DIGITAL ART NFTS</div>
